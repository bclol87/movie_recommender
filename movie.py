...
st.markdown("""
    ...
    /* HIDE STREAMLIT'S DEFAULT HEADER (The white bar issue) */
    header[data-testid="stHeader"] {
        display: none !important;
    }
    
    /* Adjust main container padding to move content up */
    .block-container { 
    ...
    /* Hide the sidebar collapse button if desired, or color it */
    [data-testid="collapsedControl"] { color: white !important; }

    /* 3. Top Bar Inputs (Search & Selectbox) */
    /* Target the actual input fields to make them dark/styled */
    .stTextInput input {
    ...
    /* Target the wrapper for the selectbox */
    ...
    .scroll-container { 
        ...
        overflow-x: auto; 
        gap: 20px; 
        padding: 20px 10px 40px 10px; /* Extra bottom padding for hover scale */
    ...
    /* 6. Prime Card Base */
    .movie-card { 
        flex: 0 0 200px; /* Slightly narrower cards */
    ...
    /* 7. Card Overlay (Appears on hover) */
    .card-overlay {
        position: absolute;
        bottom: 0;
        left: 0;
    ...
    .movie-card:hover .card-overlay {
        ...
        background-color: #1a242f; /* Solidify background on hover */
    ...
    /* Fix the divider line color */
    hr { border-color: #1f2b36 !important; }
    
    /* Make the columns align vertically in the middle */
    [data-testid="column"] { align-self: center; }
